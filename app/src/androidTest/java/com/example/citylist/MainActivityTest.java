...
public class MainActivityTest {
    ...
    public void uitest_assignment(){
        ...
        onView(withId(R.id.show1)).check(matches(isDisplayed()));
        onView(withText("Dinajpur")).check(matches(isDisplayed()));
        onView(withId(R.id.buttonR)).perform(click());
